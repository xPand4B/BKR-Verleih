...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2018 at 09:15 PM
...
--
-- Dumping data for table `rueckgabe`
--

INSERT INTO `rueckgabe` (`ID`, `fk_vID`, `fk_eID`, `rueckgabedatum`) VALUES
(1, 1, 20, '2018-05-02'),
(2, 2, 16, '2018-05-10'),
(3, 3, 5, '2018-05-16'),
(4, 4, 14, '2018-05-18'),
...
--
-- Dumping data for table `verleih`
--

INSERT INTO `verleih` (`vID`, `fk_kID`, `ausgabedatum`) VALUES
(1, 20, '2018-04-28'),
(2, 7, '2018-05-02'),
(3, 4, '2018-05-12'),
(4, 3, '2018-05-12'),
...
--
ALTER TABLE `rueckgabe`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Normal ID', AUTO_INCREMENT=10;
...
--
ALTER TABLE `verleih`
  MODIFY `vID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Verleih ID', AUTO_INCREMENT=10;
